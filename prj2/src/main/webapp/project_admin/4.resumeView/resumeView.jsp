...
function goToList(jobNum) {
    // 목록으로 돌아가기
    window.location.href = "http://localhost/prj2/project_admin/3.recruitAdmin/total_applicant.jsp?jobNum="+jobNum;
}
				...
				<div class="base profile image">
					...
					<div class="summary col-4">
						...
						<div class="item is-singleline newcomer">
							...
							<div class="description"><c:out value="${rVO.sal}"/></div><!--연봉-->
						</div>
